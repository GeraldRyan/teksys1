...
function runSearch() {
  let location:any = (<HTMLInputElement>document.getElementById("location-input")).value
  let checkin:any = (<HTMLInputElement>document.getElementById("checkin-input")).value
  let checkout:any = (<HTMLInputElement>document.getElementById("checkout-input")).value
  let adults:any = (<HTMLInputElement>document.getElementById("adults-input")).value
  let children:any = (<HTMLInputElement>document.getElementById("children-input")).value
  ...
  else{alert(`You have not been charged`)}
